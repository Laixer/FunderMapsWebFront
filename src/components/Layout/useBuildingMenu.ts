...
export function useBuildingMenu() {
  ...
  const buildingMenu = computed<BuildingMenuItem[]>(() => [
    { slug: 'pand', panel: 'BuildingPanel', icon: 'building', name: 'Pand',
      loading: false, disabled: false, route: null },
    { slug: 'locatie', panel: 'LocationPanel', icon: 'pin', name: 'Locatie',
      loading: false, disabled: false, route: null },
    { slug: 'fundering', panel: 'FoundationPanel', icon: 'file-foundation', name: 'Fundering',
      loading: false, disabled: false, route: null },
    { slug: 'statistiek', panel: 'StatisticsPanel', icon: 'graph', name: 'Statistiek',
      loading: false,
      disabled: !!(buildingId.value && statisticsStore.failedToLoad(buildingId.value)),
      route: null },
    { slug: 'funderingsrisico', panel: 'FoundationRiskPanel', icon: 'alert', name: 'Funderingsrisico',
      loading: false, disabled: false, route: null },
  ])

  const reportMenu = computed<ReportMenuItem[]>(() => [
    { slug: 'onderzoek', panel: 'InquiryPanel',
      ...
      route: null },
    { slug: 'herstel', panel: 'RecoveryPanel',
      ...
      route: null },
    { slug: 'incidenten', panel: 'IncidentsPanel',
